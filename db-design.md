...
- ***Common strategy to implement:*** the owner table of the relationship should have a foreign key to the non-owner. (many side should have key pointing to the one side)
